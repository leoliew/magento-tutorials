...
You will need access to a non-root user that has sudo privileges. If you haven't done this yet, you can run through the Ubuntu 14.04 initial server setup guide to create this account.
